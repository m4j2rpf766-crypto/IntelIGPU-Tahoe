...
cd "$(dirname "$0")/.."
mkdir -p build
clang -dynamiclib -fobjc-arc -Wall -Wextra -Werror -framework Foundation -framework Metal mapkit-resolve-compat/resolve_compat.m -o build/libReimsMapResolve.dylib
